...
namespace BouncingBall
{
    class ListBall : IEnumerable
    {
        ...
        private bool addNewBall;

        public int NumberOfBalls { get { return balls.Count(); } }
        ...
        private void Add(int xBall, int yBall)
        {
            addNewBall = true;
            xNewBall = xBall;
            yNewBall = yBall;
        }
        private int xNewBall, yNewBall;
        private void Collisions()
        {
            while (true)
            {
                if (addNewBall)
                {
                    balls.Add(new Ball(xNewBall, yNewBall, initialColor));
                    addNewBall = false;
                }
